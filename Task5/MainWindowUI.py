...
class MainWindowUI(object):
    def setupUi(self, MainWindow):
        ...
        self.gameFieldTableView.setStyleSheet("QTableView { gridline-color: grey; }")
        ...
        self.gameFieldTableView.horizontalHeader().setDefaultSectionSize(60)
        self.gameFieldTableView.verticalHeader().setDefaultSectionSize(60)
